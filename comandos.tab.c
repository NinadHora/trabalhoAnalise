...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from comandos.y  */
...
const int YY_parse_CLASS::ENTRADA=258;
const int YY_parse_CLASS::SAIDA=259;
const int YY_parse_CLASS::FIM=260;
const int YY_parse_CLASS::ENQUANTO=261;
const int YY_parse_CLASS::FACA=262;
const int YY_parse_CLASS::INC=263;
const int YY_parse_CLASS::DEC=264;
const int YY_parse_CLASS::ZERA=265;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 267 ? yytranslate[x] : 21)
...
static const short yyprhs[] = {     0,
     0,     7,    10,    12,    14,    17,    19,    25,    29,    33,
    38,    43
};

static const short yyrhs[] = {     3,
    17,     4,    17,    19,     5,     0,    17,    18,     0,    18,
     0,    11,     0,    20,    19,     0,    20,     0,     6,    11,
     7,    19,     5,     0,    11,    13,    11,     0,    11,    13,
    12,     0,     8,    14,    11,    15,     0,     9,    14,    11,
    15,     0,    10,    14,    11,    15,     0
};
...
static const short yyrline[] = { 0,
    21,    42,    50,    55,    65,    70,    73,    80,    86,    93,
    98,   104
};

static const char * const yytname[] = {   "$","error","$illegal.","ENTRADA",
"SAIDA","FIM","ENQUANTO","FACA","INC","DEC","ZERA","ID","NUM","'='","'('","')'",
"program","varlist","id","cmds","cmd",""
};
#endif

static const short yyr1[] = {     0,
    16,    17,    17,    18,    19,    19,    20,    20,    20,    20,
    20,    20
};
...
static const short yypact[] = {     0,
     8,-32768,    -3,-32768,     8,-32768,    -4,    10,     9,    11,
    12,    -2,    17,     4,    20,    18,    19,    21,     6,-32768,
    -2,-32768,     4,    16,    22,    23,-32768,-32768,    28,-32768,
-32768,-32768,-32768,    24,    34,-32768
};
...
static const short yytable[] = {    22,
     5,     8,     1,     9,    10,    11,    12,     2,    29,     8,
    19,     9,    10,    11,    21,     6,    27,    28,     2,     6,
    15,    20,    16,    35,    17,    18,    23,     0,    24,    25,
    30,    26,    33,    36,     7,     0,    31,    32
};

static const short yycheck[] = {    14,
     4,     6,     3,     8,     9,    10,    11,    11,    23,     6,
    13,     8,     9,    10,    11,     3,    11,    12,    11,     7,
    11,     5,    14,     0,    14,    14,     7,    -1,    11,    11,
    15,    11,     5,     0,     5,    -1,    15,    15
};
...
{    
        ...
        if (out == NULL) exit(1);
        char* total = malloc(strlen(yyvsp[-4].id) + strlen(yyvsp[-2].id) + strlen(yyvsp[-1].id) + 15);
        strcpy(total, "int main() {" );
        strcat(total, yyvsp[-4].id); strcat(total, yyvsp[-2].id); strcat(total, yyvsp[-1].id);
        strcat(total, "}");   
        fprintf(out, "%s", total);
        fclose(out);
...
#line 43 "comandos.y"
{
        char* mostra = malloc(strlen(yyvsp[-1].id) + strlen(yyvsp[0].id) + 1);
        strcpy(mostra, yyvsp[-1].id);
        strcat(mostra, yyvsp[0].id);
        yyval.id = mostra;
;
    break;}
case 3:
...
#line 56 "comandos.y"
{
    char* mostra = malloc(strlen(yyvsp[0].id) + 11);
   strcpy(mostra, "int");
    strcat(mostra, yyvsp[0].id); strcat(mostra, " = 0;\n");
    yyval.id = mostra;
  ;
    break;}
case 5:
...
{
    char* mostra = malloc(strlen(yyvsp[-1].id) + strlen(yyvsp[0].id) + 1);
    strcpy(mostra, yyvsp[-1].id); strcat(mostra, yyvsp[0].id); yyval.id = mostra;
  ;
    break;}
case 6:
#line 70 "comandos.y"
...
#line 74 "comandos.y"
{
char* mostra = malloc(strlen(yyvsp[-3].id) + strlen(yyvsp[-1].id) + 12); strcpy(mostra, "while(");
strcat(mostra, yyvsp[-3].id); strcat(mostra, "){\n"); strcat(mostra, yyvsp[-1].id); strcat(mostra, "}\n");
yyval.id = mostra;
;
    break;}
case 8:
#line 80 "comandos.y"
{
    char* mostra = malloc(strlen(yyvsp[-2].id) + strlen(yyvsp[0].id) + 6); strcpy(mostra, yyvsp[-2].id);
    strcat(mostra, " = "); strcat(mostra, yyvsp[0].id); strcat(mostra, ";\n"); 
    yyval.id = mostra;
;
    break;}
case 9:
...
#line 93 "comandos.y"
{
    char* mostra = malloc(strlen(yyvsp[-1].id) + 5); strcpy(mostra, yyvsp[-1].id);
    strcat(mostra, "++\n"); yyval.id = mostra
;
    break;}
case 11:
...
#line 104 "comandos.y"
{
    char* mostra = malloc(strlen(yyvsp[-1].id) + 7); strcpy(mostra, yyvsp[-1].id);
    strcat(mostra, " = 0\n"); 
    yyval.id = mostra;
;
    break;}
